            ...
            <div class=" text-gray-500 ">
                        <table class="rounded-t-lg ml-10 w-5/6 max-auto bg-gray-200 text-gray-800">
                            <tr class="text-left border-b-2 border-gray-300">
                                ...
                                <th class="px-4 py-3">Wallet Addres</th>
                            ...
                            <tr class="bg-gray-100 border-b border-gray-200">
                                ...
                                <td class="px-4 py-3">euro</td>
                                <td class="px-4 py-3">1000</td>
                                <td class="px-4 py-3">www.euro.com.ng</td>
                            ...
                            <tr class="bg-gray-100 border-b border-gray-200">
                                ...
                                <td class="px-4 py-3">Dollar</td>
                                <td class="px-4 py-3">1000</td>
                                <td class="px-4 py-3">www.dollar.com.ng</td>
                                <td class="px-4 py-3">Musa Umar</td>
                                <td class="px-4 py-3">Completed</td>
