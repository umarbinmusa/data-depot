      ...
      <div class="w-6xl px-5 mx-auto mt-3 text-center bg-white shadow-lg m-5 p-5">
        ...
        <form>
          ...
          <div class="flex ">
            ...
            <input type="text" name="username" id="username" autocomplete="username" class="block w-full rounded-lg border-0 py-1.5 text-gray-900" placeholder="enter  Reciept Number" />
          </div>
          <div class="flex mt-5 ">
